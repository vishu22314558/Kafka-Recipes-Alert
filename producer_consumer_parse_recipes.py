...
# step 2
#The next script we are going to write will serve as both consumer and producer. 
#First it will consume data from raw_recipes topic, parse and transform data into JSON and 
# then will publish it in parsed_recipes topic. Below is the code that will fetch HTML data from 
# raw_recipes topic, parse and then feed into parsed_recipes topic.

# KafkaConsumer accepts a few parameters beside the topic name and host address. 
